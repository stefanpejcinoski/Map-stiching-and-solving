...
from ImageTools.Tools import shortenPath,shortPath,  grayscale, loadImage, maxPoolResize, scaleCoordinates, drawPath, display, resize, moveCommands
import os
import numpy as np
import cv2
start=(1304, 32)
...
gmap=grayscale(map)
nmap,_,_=maxPoolResize(gmap, 10)
print("done")
